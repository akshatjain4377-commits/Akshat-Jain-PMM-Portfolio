      ...
      <section className="relative mx-auto flex max-w-7xl flex-col items-center justify-between gap-12 px-6 py-24 lg:flex-row lg:py-32">
        <div className="flex-1 space-y-8">
          ...
          <motion.p 
            ...
            className="max-w-2xl text-lg text-brand-muted md:text-xl leading-relaxed"
          >
            Product marketing built on customer insight, positioning clarity, and distribution systems that turn ideas into product momentum. <br /> I study how narratives spread, how markets perceive value,
and why certain products gain traction while others fade.
          </motion.p>
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <Link to="/work/acko" className="group block overflow-hidden rounded-2xl border border-brand-border bg-brand-card transition-colors hover:border-brand-accent/50">
              <div className="aspect-[16/9] w-full overflow-hidden bg-brand-bg p-8">
                <img src="https://raw.githubusercontent.com/akshatjain4377-commits/Akshat-Jain-PMM-Portfolio/main/acko-insurance.png" alt="ACKO Insurance" className="h-full w-full object-cover rounded-lg opacity-80 group-hover:opacity-100 transition-opacity" referrerPolicy="no-referrer" />
              </div>
              <div className="p-8">
            ...
            <Link to="/work/peak-view" className="group block overflow-hidden rounded-2xl border border-brand-border bg-brand-card transition-colors hover:border-brand-accent/50">
              <div className="aspect-[16/9] w-full overflow-hidden bg-brand-bg p-8">
                <img src="https://raw.githubusercontent.com/akshatjain4377-commits/Akshat-Jain-PMM-Portfolio/main/the-peak-view-stories.jpg" alt="The Peak View Stories" className="h-full w-full object-cover rounded-lg opacity-80 group-hover:opacity-100 transition-opacity" referrerPolicy="no-referrer" />
              </div>
              <div className="p-8">
                <div className="mb-4 flex gap-2">
            ...
            <Link to="/work/business-standard" className="group block overflow-hidden rounded-2xl border border-brand-border bg-brand-card transition-colors hover:border-brand-accent/50">
              <div className="aspect-[16/9] w-full overflow-hidden bg-brand-bg p-8">
                <img src="https://raw.githubusercontent.com/akshatjain4377-commits/Akshat-Jain-PMM-Portfolio/main/business-standard.jpg" alt="Business Standard" className="h-full w-full object-cover rounded-lg opacity-80 group-hover:opacity-100 transition-opacity" referrerPolicy="no-referrer" />
              </div>
              <div className="p-8">
                <div className="mb-4 flex gap-2">
