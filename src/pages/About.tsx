            ...
            {[
              {
                ...
                desc: "Built and launched a satire news platform end-to-end — from website and editorial positioning to distribution. Scaled organic reach with multiple posts crossing 1.5M+ views."
              },
              {
                year: "2023 - Present",
                role: "SEO Executive",
                company: "Business Standard",
                desc: "Driving organic growth for financial content including IPO stories, earnings coverage, and company pages."
              },
              {
                year: "2021 - 2022",
                role: "Digital PR & Content Strategist",
                company: "RankSoldier",
                desc: "Built authority and thought leadership for founders through journalist platforms like HARO, Terkel, SourceBottle, and Qwoted."
              },
              {
                year: "2021",
                role: "Market Research Intern",
                company: "Explorra Design Institute",
                desc: "Conducted market research across institutions and built structured datasets for outreach initiatives."
              }
            ].map((exp, i) => (
